...
MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege() {
    this->initializeModel();
}

MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::~MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege() {}

void MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::initializeModel() {
...
void MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::fromJsonObject(QJsonObject json) {
...
QJsonObject MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::asJsonObject() const {
    QJsonObject obj;
...
bool MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::isResConsumable() const {
    return m_res_consumable;
}
void MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::setResConsumable(const bool &res_consumable) {
    m_res_consumable = res_consumable;
    m_res_consumable_isSet = true;
}

bool MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::is_res_consumable_Set() const{
    return m_res_consumable_isSet;
}

bool MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::is_res_consumable_Valid() const{
    return m_res_consumable_isValid;
}

bool MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::isUserConsumable() const {
    return m_user_consumable;
}
void MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::setUserConsumable(const bool &user_consumable) {
    m_user_consumable = user_consumable;
    m_user_consumable_isSet = true;
}

bool MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::is_user_consumable_Set() const{
    return m_user_consumable_isSet;
}

bool MDSearch_200_response_result_songs_inner_privilege_freeTrialPrivilege::is_user_consumable_Valid() const{
