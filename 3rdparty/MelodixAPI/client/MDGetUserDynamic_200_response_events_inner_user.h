...
/*
 * MDGetUserDynamic_200_response_events_inner_user.h
 *
 * 
 */

#ifndef MDGetUserDynamic_200_response_events_inner_user_H
#define MDGetUserDynamic_200_response_events_inner_user_H
...
class MDGetUserDynamic_200_response_events_inner_user_vipRights;

class MDGetUserDynamic_200_response_events_inner_user : public MDObject {
public:
    MDGetUserDynamic_200_response_events_inner_user();
    MDGetUserDynamic_200_response_events_inner_user(QString json);
    ~MDGetUserDynamic_200_response_events_inner_user() override;
    ...
    bool isUrlAnalyze() const;
    void setUrlAnalyze(const bool &url_analyze);
    bool is_url_analyze_Set() const;
    bool is_url_analyze_Valid() const;

    MDGetUserDynamic_200_response_events_inner_user_vipRights getVipRights() const;
    void setVipRights(const MDGetUserDynamic_200_response_events_inner_user_vipRights &vip_rights);
...
private:
    ...
    bool m_url_analyze;
    bool m_url_analyze_isSet;
    bool m_url_analyze_isValid;

    MDGetUserDynamic_200_response_events_inner_user_vipRights m_vip_rights;
...
Q_DECLARE_METATYPE(MelodixAPI::MDGetUserDynamic_200_response_events_inner_user)

#endif // MDGetUserDynamic_200_response_events_inner_user_H
