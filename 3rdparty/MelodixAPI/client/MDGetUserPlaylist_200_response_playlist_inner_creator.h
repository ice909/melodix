...
class MDGetUserPlaylist_200_response_playlist_inner_creator_experts;
...
public:
    ...
    MDGetUserPlaylist_200_response_playlist_inner_creator_experts getExperts() const;
    void setExperts(const MDGetUserPlaylist_200_response_playlist_inner_creator_experts &experts);
...
private:
    ...
    MDGetUserPlaylist_200_response_playlist_inner_creator_experts m_experts;
