...
MDGetArtistSingle_200_response_songs_inner_al MDGetPlaylistTrackAll_200_response_songs_inner::getAl() const {
    return m_al;
}
void MDGetPlaylistTrackAll_200_response_songs_inner::setAl(const MDGetArtistSingle_200_response_songs_inner_al &al) {
    m_al = al;
    m_al_isSet = true;
}
