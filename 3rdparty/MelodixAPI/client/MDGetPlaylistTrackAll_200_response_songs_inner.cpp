...
void MDGetPlaylistTrackAll_200_response_songs_inner::initializeModel() {
    ...
    m_origin_song_simple_data_isSet = false;
    m_origin_song_simple_data_isValid = false;
...
void MDGetPlaylistTrackAll_200_response_songs_inner::fromJsonObject(QJsonObject json) {
    ...
    m_origin_song_simple_data_isValid = ::MelodixAPI::fromJsonValue(m_origin_song_simple_data, json[QString("originSongSimpleData")]);
    m_origin_song_simple_data_isSet = !json[QString("originSongSimpleData")].isNull() && m_origin_song_simple_data_isValid;
...
QJsonObject MDGetPlaylistTrackAll_200_response_songs_inner::asJsonObject() const {
    ...
    if (m_origin_song_simple_data.isSet()) {
        obj.insert(QString("originSongSimpleData"), ::MelodixAPI::toJsonValue(m_origin_song_simple_data));
    }
...
QList<MDGetPlaylistDetail_200_response_playlist_tracks_inner_ar_inner> MDGetPlaylistTrackAll_200_response_songs_inner::getAr() const {
    return m_ar;
}
void MDGetPlaylistTrackAll_200_response_songs_inner::setAr(const QList<MDGetPlaylistDetail_200_response_playlist_tracks_inner_ar_inner> &ar) {
    m_ar = ar;
    m_ar_isSet = true;
}
...
MDGetArtistSingle_200_response_hotSongs_inner_sq MDGetPlaylistTrackAll_200_response_songs_inner::getH() const {
    return m_h;
}
void MDGetPlaylistTrackAll_200_response_songs_inner::setH(const MDGetArtistSingle_200_response_hotSongs_inner_sq &h) {
    m_h = h;
    m_h_isSet = true;
}
...
MDGetArtistSingle_200_response_hotSongs_inner_sq MDGetPlaylistTrackAll_200_response_songs_inner::getM() const {
    return m_m;
}
void MDGetPlaylistTrackAll_200_response_songs_inner::setM(const MDGetArtistSingle_200_response_hotSongs_inner_sq &m) {
    m_m = m;
    m_m_isSet = true;
}
...
MDGetArtistSingle_200_response_hotSongs_inner_h MDGetPlaylistTrackAll_200_response_songs_inner::getL() const {
    return m_l;
}
void MDGetPlaylistTrackAll_200_response_songs_inner::setL(const MDGetArtistSingle_200_response_hotSongs_inner_h &l) {
    m_l = l;
    m_l_isSet = true;
}
...
MDGetArtistSingle_200_response_hotSongs_inner_sq MDGetPlaylistTrackAll_200_response_songs_inner::getSq() const {
    return m_sq;
}
void MDGetPlaylistTrackAll_200_response_songs_inner::setSq(const MDGetArtistSingle_200_response_hotSongs_inner_sq &sq) {
    m_sq = sq;
    m_sq_isSet = true;
}
...
MDGetArtistSingle_200_response_hotSongs_inner_sq MDGetPlaylistTrackAll_200_response_songs_inner::getHr() const {
    return m_hr;
}
void MDGetPlaylistTrackAll_200_response_songs_inner::setHr(const MDGetArtistSingle_200_response_hotSongs_inner_sq &hr) {
    m_hr = hr;
    m_hr_isSet = true;
}
