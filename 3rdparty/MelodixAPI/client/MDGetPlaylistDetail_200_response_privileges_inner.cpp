...
QList<MDGetArtistSingle_200_response_hotSongs_inner_privilege_chargeInfoList_inner> MDGetPlaylistDetail_200_response_privileges_inner::getChargeInfoList() const {
    return m_charge_info_list;
}
void MDGetPlaylistDetail_200_response_privileges_inner::setChargeInfoList(const QList<MDGetArtistSingle_200_response_hotSongs_inner_privilege_chargeInfoList_inner> &charge_info_list) {
