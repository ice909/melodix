...
public:
    ...
    static MDSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new MDSerializerSettings();
        }
        return instance;
    }

private:
    explicit MDSerializerSettings(){
        instance = this;
        customDateTimeFormat.isStringSet = false;
        customDateTimeFormat.isEnumSet = false;
    }
    static MDSerializerSettings *instance;
    CustomDateTimeFormat customDateTimeFormat;
};

MDSerializerSettings * MDSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        MDSerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        MDSerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (MDSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(MDSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (MDSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(MDSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QString toStringValue(const MDObject &value) {
    return value.asJson();
}

QString toStringValue(const MDEnum &value) {
    return value.asJson();
}

QString toStringValue(const MDHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (MDSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(MDSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (MDSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(MDSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
QJsonValue toJsonValue(const MDObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const MDEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const MDHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (MDSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, MDSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (MDSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, MDSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromStringValue(const QString &inStr, MDObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, MDEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, MDHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (MDSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), MDSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (MDSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), MDSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(MDObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(MDEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(MDHttpFileElement &value, const QJsonValue &jval) {
