...
MDSearch_200_response_result_songs_inner_al MDSearch_200_response_result_songs_inner::getAl() const {
    return m_al;
}
void MDSearch_200_response_result_songs_inner::setAl(const MDSearch_200_response_result_songs_inner_al &al) {
    m_al = al;
    m_al_isSet = true;
}
...
bool MDSearch_200_response_result_songs_inner::isValid() const {
    ...
    return m_name_isValid && m_id_isValid && m_ar_isValid && m_al_isValid && m_dt_isValid && m_copyright_isValid && m_resource_state_isValid && m_version_isValid && m_single_isValid && m_mv_isValid && m_publish_time_isValid && true;
}
