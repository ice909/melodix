...
#ifndef MDGetArtistMv_200_response_mvs_inner_artist_H
#define MDGetArtistMv_200_response_mvs_inner_artist_H
...
class MDGetArtistMv_200_response_mvs_inner_artist : public MDObject {
public:
    MDGetArtistMv_200_response_mvs_inner_artist();
    MDGetArtistMv_200_response_mvs_inner_artist(QString json);
    ~MDGetArtistMv_200_response_mvs_inner_artist() override;
...
Q_DECLARE_METATYPE(MelodixAPI::MDGetArtistMv_200_response_mvs_inner_artist)

#endif // MDGetArtistMv_200_response_mvs_inner_artist_H
