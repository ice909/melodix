...
#ifndef MDGetAccountInfo_200_response_profile_H
#define MDGetAccountInfo_200_response_profile_H
...
class MDGetAccountInfo_200_response_profile : public MDObject {
public:
    MDGetAccountInfo_200_response_profile();
    MDGetAccountInfo_200_response_profile(QString json);
    ~MDGetAccountInfo_200_response_profile() override;
    ...
    void setBirthday(const double &birthday);
...
Q_DECLARE_METATYPE(MelodixAPI::MDGetAccountInfo_200_response_profile)

#endif // MDGetAccountInfo_200_response_profile_H
