 ...
 */
#ifndef MD_SERVERVCONFIGURATION_H
#define MD_SERVERVCONFIGURATION_H
...
#include <QUrl>
#include <stdexcept>
#include "MDServerVariable.h"

namespace MelodixAPI {

class MDServerConfiguration {
public:
    /**
     ...
     */
    MDServerConfiguration(const QUrl &url, const QString &description, const QMap<QString, MDServerVariable> &variables)
    : _description(description),
      _variables(variables),
      _url(url){}
    MDServerConfiguration(){}
    ~MDServerConfiguration(){}
    ...
    QString URL() {
        ...
        if(!_variables.empty()){
            ...
            for (auto const& v : _variables.keys()) {
                QString name = v;
                MDServerVariable serverVariable = _variables.value(v);
    ...
    QMap<QString, MDServerVariable> _variables;
    QUrl _url;
...
#endif // MD_SERVERVCONFIGURATION_H
